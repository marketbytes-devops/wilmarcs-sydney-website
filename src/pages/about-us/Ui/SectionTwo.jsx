  ...
  return (
    <section className="container mx-auto">
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-20">
        ...
        <div className="mt-0 lg:mt-0 flex items-center lg:justify-start justify-center gap-2 lg:gap-4 lg:h-full">
        ...
        <div className="flex flex-col justify-center lg:justify-start ">
          <h2 className="font-bold -mt-4 lg:mt-0 text-gray-900 leading-tight text-center lg:text-left">
       ...
       <div className="mt-2 w-full flex flex-col lg:flex-row">
        ...
        <div className="lg:w-[78%] w-full grid grid-cols-1 sm:grid-cols-3 gap-6 lg:gap-0 text-left">
          {/* Stat 1 */}
          <div className="relative px-6 lg:px-4">
            ...
            <h6 className=" font-bold text-gray-900 mt-4">
              A top creative company
            </h6>
            <p className="mt-10 lg:mt-20 py-2 lg:py-5 text-gray-600 leading-relaxed">
          ...
          <div className="relative px-6 lg:px-4">
           <div className="absolute -left-1 top-1 w-5 h-5 bg-[#8D8D8D] rounded-full"></div>
            ...
            <h6 className="font-extrabold text-gray-900 mt-4">
              300+ global<br/> partners
            </h6>
            <p className="mt-10 lg:mt-20 py-2 lg:py-5  text-base text-gray-600">
              Wilmarcs Motion Pictures is a dedicated film studio specializing in structured and intentional storytelling.
            </p>
          </div>
          ...
          <div className="relative px-6 lg:px-4">
            ...
            <p className="mt-10 lg:mt-24 py-4 lg:py-8 text-gray-600 leading-relaxed">
              Wilmarcs Motion Pictures is a dedicated film studio specializing in structured and intentional storytelling.
            </p>
          </div>
        </div>
