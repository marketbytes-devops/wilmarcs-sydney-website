  ...
  return (
    <>
      ...
      <div>
        ...
        <div className="grid grid-cols-1  lg:grid-cols-12 gap-4 py-3 lg:px-0 px-6">
          {/* Left Halftone Image */}
          ...
          <div className="hidden lg:block col-span-1  lg:col-span-3 items-center justify-end relative lg:-left-32">
            <div className="flex flex-col md:flex-row lg:flex-row w-full gap-4">
              <Image
                ...
                width={112}
                height={128}
                className="w-full md:w-28 lg:w-28 h-32 lg:h-32 rounded-lg shadow-lg object-cover"
              />
              <Image
                src={lastPic2}
                alt="Project 2"
                width={183}
                height={228}
                className="w-full md:w-[183px] lg:w-[183px] h-56 md:h-[228px] lg:h-[228px] rounded-lg shadow-lg object-cover"
              />
              <Image
                src={lastPic3}
                alt="Project 3"
                width={128}
                height={144}
                className="w-full md:w-32 lg:w-32 h-36 lg:h-36 rounded-lg shadow-lg object-cover"
              />
            </div>
          </div>
        </div>
